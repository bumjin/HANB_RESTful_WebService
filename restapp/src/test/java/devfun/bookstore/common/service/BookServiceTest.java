...
public class BookServiceTest {
	...
	public void testGetBook() {
		...
		assertNotNull ("아이디가 1번인 도서 정보를 가져올 수 없습니다.",
		selectedBook);
	...
	public void testCreateBook() {
		...
		Book newBook = new Book(10L, "스칼라 프로그래밍", "케이 호스트만",
		"프로그래밍 언어", new Date());
		bookService.createBook(newBook);
		selectedBook = bookService.getBook(10L);
		assertNotNull ("아이디가 10번인 도서 정보를 가져올 수 없습니다.",
		selectedBook);
	...
	public void testDeleteBook() {
		...
		selectedBook = bookService.getBook(3L);
		assertNull ("아이디가 3번인 도서 정보가 삭제되지 않았습니다.",
		selectedBook);
	}
}